...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestReport = __webpack_require__(5);
	__webpack_require__(54);

	domready(function () {
	  return m.mount(document.body, TestReport);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TestSuite = __webpack_require__(53);
	...
	var TestReport = {
	  viewModel: {
	    ...
	    onRunStart: function onRunStart() {
	      TestReport.viewModel.working(true);
	      _.map(TestReport.viewModel.browsers, function (b) {
	        return b.clear();
	      });
	      m.redraw();
	    },
	    ...
	    onSpec: function onSpec(_ref) {
	      ...
	      var b = _.find(TestReport.viewModel.browsers, { id: browser.id });
	    ...
	    toDom: function toDom(test, describe) {
	  ...
	  view: function view(ctrl) {
	    return _.map(ctrl.browsers, function (_ref2) {
	      var name = _ref2.name;
	      var fullName = _ref2.fullName;
	      var tests = _ref2.tests;
	      var passed = _ref2.passed;
	      var failed = _ref2.failed;
	      var skipped = _ref2.skipped;
	      return m('div', [m('div.counts', [ctrl.working() ? m('span.working-label', 'working...') : [m('span.count-label', 'passed:'), m('span.count', passed()), m('span.count-label', 'failed:'), m('span.count', failed()), m('span.count-label', 'skipped:'), m('span.count', skipped())]]), m('h1.browser-header', { title: fullName }, name), m('div', _.map(tests, TestReport.viewModel.toDom))]);
	    });
	  }
	};
	...
	var TestSuite = function () {
	  ...
	  _createClass(TestSuite, [{
	    ...
	    value: function addTest(_ref2) {
	      ...
	      _.merge(this.tests, _.reduce(_.reverse(describes), function (test, describe) {
	        return _defineProperty({}, describe, test);
	      }, _defineProperty({}, description, {
